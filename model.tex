...
\section{IRIW}
Check the examples in \cite[Fig 17]{DBLP:journals/pacmpl/BenderP19}.  They
should all be allowed.  That semantics is based on two partial orders, I
think: co and vo (although vo is perhaps not transitive).

Also check example from
\url{https://bugs.openjdk.java.net/browse/JDK-8262877}, which should be forbidden.
...
Need $\ltdep$ to prevent thin air on $\mRLX$:
\begin{gather*}
  \PW{y}{\PR{x}{}}\PAR
  \PW{x}{\PR{y}{}}
  \\
