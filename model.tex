...
Based on \cite{DBLP:conf/asplos/LustigSG19}.
...
About Release-Acquire semantics.  Not sure the status of this example in C11
and \IMM{}:
\begin{gather*}
  \taglabel{LB-REL}
...
ARM allows some counterintuitive results for SC access \texttt{[ctrl-rfi-bob-fre-rfe]}:
\begin{gather*}
