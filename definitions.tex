...
\begin{align*}
  \aCtxt
  \BNFDEF& \hole{}
  \BNFSEP \IF{\aExp} \THEN \aCtxt_1 \ELSE \aCmd_2 \FI
  \BNFSEP \IF{\aExp} \THEN \aCmd_1 \ELSE \aCtxt_2 \FI
  \\[-.5ex]
  \BNFSEP& \aCtxt_1 \SEMI \aCmd_2
  \BNFSEP \aCmd_1 \SEMI \aCtxt_2
  \BNFSEP \aCtxt_1 \LPAR[\bThrd] \aCmd_2
  \BNFSEP \aCmd_1 \LPAR[\bThrd] \aCtxt_2
\end{align*}
\begin{lemma}
